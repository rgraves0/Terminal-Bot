...
token = os.environ.get("6097600899:AAEykeRWsr0iXvqp2zk8fer6vcyHNlsZ0eE")
app_id = int(os.environ.get("8802706"))
app_hash = os.environ.get("97546900397a98f481bfb8252b1ac4f4")
